...
import com.laker.xlibs.utils.handler.XHandler;
...
public class XHttp implements IHttpEngine {
    ...
    @Override
    public void upload(String url, Map<String, Object> params, HttpCallBack callBack) {
        httpEngine.upload(url,params,callBack);
    }

    @Override
    public void download(String url, Map<String, Object> params, HttpCallBack callBack) {
        httpEngine.download(url,params,callBack);
    }
}
