...
public class TimePickerDialog extends DialogFragment implements View.OnClickListener {
    ...
    View initView() {
        ...
        tv_title.setText(mPickerConfig.mTitleString);
    ...
    public void show(FragmentActivity context) {
        showWithTile(context,"");
    }

    public void showWithTile(FragmentActivity context,String title) {
//        mPickerConfig.mTitleString = title;
        show(context.getSupportFragmentManager(),title,
                mPickerConfig.mTitleString + System.currentTimeMillis());
    }

    public void show(FragmentManager manager, String title, String tag) {
        mPickerConfig.mTitleString = title;
