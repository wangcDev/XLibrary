package com.laker.xlibrary.view;
...
import com.laker.xlibrary.view.dto.ConfigAreaDTO;
import com.laker.xlibrary.view.dto.ConfigsDTO;
import com.laker.xlibrary.view.dto.ConfigsMessageDTO;
...
//            ConfigsMessageDTO messageDTO = JSONObject.parseObject(searchTypeJson, ConfigsMessageDTO.class);
            ConfigsMessageDTO messageDTO = new Gson().fromJson(searchTypeJson, ConfigsMessageDTO.class);
